...
public static String getLeastNumberDeletingDigits_2(String number, int k) {
    ...
    while(k > 0 && leastNumber.length() > 0) {
    	LeastNumber  result = getLeastNumber (leastNumber, start);
...
private static LeastNumber  getNextDecreasing(String number, int start) {
    ...
    LeastNumber  result = new LeastNumber ();
